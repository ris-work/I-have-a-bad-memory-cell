RAM is expensive now. It has gone up in price by nearly 3x. There are less things we can do when RAM is this expensive. It used to cost $4/GiB, now about $16/GiB (Sri Lanka).
